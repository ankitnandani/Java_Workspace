...
public class Task01 implements ActionListener,ListSelectionListener
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource() == btn7)
		{
			...
			String query = "select * from tasktwo where id = '"+tf1.getText().toString()+"';";
			...
			try
			{
				...
				{
					tf1.setText(String.valueOf(rs1.getInt(1)));
					tf2.setText(rs1.getString(2));
					
					if(rs1.getString(3) == "Male")
					{
					...
					tf3.setText(rs1.getString(4));
					tf4.setText(rs1.getString(5));
				}
			}
			catch(Exception e1)
			{
